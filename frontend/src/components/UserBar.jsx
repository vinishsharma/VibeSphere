...
//   // setting the initial follow state
//   useEffect(() => {
//     if (user && targetUser?.followers?.includes(user._id)) {
//       setIsFollowing(true);
//     } else {
...
//     navigate(`/profile/${targetUser._id}`); // Navigate to user profile page
//   }

//   const handleFollowUnfollow = async () => {
//     try {
//       const response = await axios.put(`/api/user/follow/${targetUser._id}`,
//         {},
//         { withCredentials: true }
//       );

//       console.log(response.data.tuFollowers);
...
//       setIsFollowing(response.data.tuFollowers.includes(user._id));
...
//       <div className="flex">
//         <img
//           src={targetUser.profilePicture || "profile.jpg"} // Default image if none
//           alt={targetUser.name}
...
//         <button className={`px-4 py-1 rounded-lg border transition font-medium cursor-pointer ${isFollowing
...
//         </button>
//         <button className="px-4 py-1 bg-white border text-blue-400 border-blue-400 hover:bg-blue-400 hover:text-white rounded-lg cursor-pointer" onClick={handleViewProfile}>
//           View
//         </button>
