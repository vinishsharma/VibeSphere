...
const SkeletonCard = () => (
  <div className="flex-none w-[90vw] sm:w-[50vw] md:w-[40vw] lg:w-[30vw] p-4">
    ...
    <div className="relative overflow-hidden rounded-2xl w-full h-[70vh] p-5 bg-gradient-to-r from-pink-200 via-purple-200 to-blue-200 animate-gradient-x">
      ...
      <div className="w-full h-[40vh] bg-white/70 rounded-xl mb-4"></div>
